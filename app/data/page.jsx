          ...
          <section className="main-section-top">
            ...
            <div className="main-section-top_left" id="main-section-top_left--data-page">
              ...
              <div className="tab-container">
                <button className="tab-container-item tab-container-item--active">CUSTOMER</button>
                <button className="tab-container-item">SCHEDULING</button>
                <button className="tab-container-item">LOCATIONS</button>
                <button className="tab-container-item">OTHER</button>
              </div>

              <div className="tab-container no-border">
                <button className="tab-container-item tab-container-item--active no-border">LIST</button>
                <button className="tab-container-item no-border">TRIPS</button>
              </div>
              ...
              <div className="trip-charge-container ">
                ...
                <div className="trip-charge-container_first-container">
                  ...
                  <button className="primary-btn w--fit">MERGE</button>
